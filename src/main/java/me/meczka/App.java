    ...
    public class App
    {
        ...
        public static HashMap<String,Long> recentlyRestocked = new HashMap<>();
        ...
        public synchronized void resolveItems(List<Item> items, OkHttpClient httpClient)
        {
            for(Item item : items)
            {
                String name = item.getName();
                name = name.toLowerCase();
                if(name.contains("jordan") || name.contains("yeezy") || name.contains("air") && name.contains("max")) {
                    ...
                    if (databaseItem == null) {
                        ...
                        if(Comparator.compare(item,databaseItem,httpClient)) {
